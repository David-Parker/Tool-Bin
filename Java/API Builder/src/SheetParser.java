...
public class SheetParser {
	...
	public static final String sameVi = "\"\"";
	...
	public Folder parse(String[][] data, int rows, int cols) {
		...
		if(!hasUtilityFolder(root)) {
			System.out.println("No Utility Found");
...
//			printFolders(root,0);
	...
	public static boolean checkSource(Vi newVi) {
